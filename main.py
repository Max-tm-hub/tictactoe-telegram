...
# Валидация initData
def validate_init_data(init_data: str, bot_token: str) -> dict: # Исправлено: init_data: str, а не init_ str
    try:
...
def update_game(game_id: str, data: dict): # Исправлено: data: dict, а не  dict
    try:
